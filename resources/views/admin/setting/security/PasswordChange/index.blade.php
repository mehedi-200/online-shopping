        ...
        <div class="container">
            <div class="row justify-content-center text-center">
                <div class="col-md-4 mb-4">
                    <div class="feature-box p-4 shadow-sm rounded bg-white">
                        <div class="icon mb-3">
                            <i class="fas fa-envelope fa-3x text-primary"></i>
                        </div>
                        <h5>{{__('app.update').' '.__('app.email')}}</h5>
                        <p>{{__('app.pwd_email_title')}}</p>
                ...
                <div class="col-md-4 mb-4">
                    <div class="feature-box p-4 shadow-sm rounded bg-white">
                        ...
                        <h5>{{__('app.enable').' '.__('2fa')}}</h5>
                        <p id="titleOfEmail" class="size">{{__('app.pwd_2fa_title')}}</p>
                ...
                <div class="col-md-4 mb-4">
                    <div class="feature-box p-4 shadow-sm rounded bg-white">
                        ...
                        <h5 id="titleOf">{{__('app.change').' '.__('app.password')}}</h5>
                        <p id="titleOfEmail">{{__('app.pwd_change_title')}}</p>
