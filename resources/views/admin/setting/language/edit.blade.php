            ...
            <div class="theme-card-body">
                <form action="{{route('language.update',[$language->id])}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="custom-form-group custom-form-group-sm mb-3 row">
                        ...
                        <div class="col-lg-8">
                            <input type="text" name="language" value="{{$language->language}}" placeholder="{{__('app.language').' '.__('name')}}" class="form-control">
                        </div>
                    </div>
                    <div class="custom-form-group custom-form-group-sm mb-3 row">
                        <label for="name" class="col-lg-4 text-lg-right form-label">{{__('app.iso_code')}}</label>
                        <div class="col-lg-8">
                            <input type="text" name="iso_code" value="{{$language->iso_code}}" placeholder="{{__('app.iso_code')}}" class="form-control">
                        </div>
                    </div>
                    <div class="custom-form-group custom-form-group-sm mb-3 row">
