            ...
            <div class="theme-card-body">
                ...
                <form action="{{route('user.update',[$user->id])}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="custom-form-group custom-form-group-sm mb-3 row">
                        <label for="name" class="col-lg-4 text-lg-right form-label">Name</label>
                        <div class="col-lg-8">
                            <input type="text" name="name" value="{{$user->name}}" placeholder="Name" class="form-control"  required>
                        </div>
                    </div>
                    <div class="custom-form-group custom-form-group-sm mb-3 row">
                        <label for="email" class="col-lg-4 text-lg-right form-label">Email</label>
                        <div class="col-lg-8">
                            <input type="email" name="email" value="{{$user->email}}" placeholder="Email address" class="form-control"  required>
                        </div>
                    </div>
                    <div class="custom-form-group custom-form-group-sm mb-3 row">
                        <label for="password" class="col-lg-4 text-lg-right form-label">Password</label>
                        <div class="col-lg-8">
                            <input type="password" name="password" placeholder="Password" class="form-control" minlength="8"  >
                        </div>
                    </div>
                    <div class="custom-form-group custom-form-group-sm mb-3 row">
                    ...
                    <div class="custom-form-group custom-form-group-sm mb-3 row">
                        <label for="image" class="col-lg-4 text-lg-right form-label">Select Role</label>
                        <div class="col-lg-8">
                            <select name="role_id" id="role_id" class="form-control role" required>
