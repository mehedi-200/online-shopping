    ...
    <main class="main-content">
        ...
        <div class="theme-card">
            <div class="theme-card-header d-flex justify-content-between">
                <h6 class="theme-card-title">{{__('app.create').' '.__('app.product')}}</h6>
            </div>
            <div class="theme-card-body">
                <form action="{{route('product.store')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="custom-form-group custom-form-group-sm mb-3 row">
                        ...
                        <div class="col-lg-8">
                            <input type="text" name="name" placeholder="{{__('app.product').' '.__('app.name')}}" class="form-control"  required>
                        </div>
                    </div>
                    <div class="custom-form-group custom-form-group-sm mb-3 row">
                        <label for="name" class="col-lg-4 text-lg-right form-label">{{__('app.title')}} :</label>
                        <div class="col-lg-8">
                            <input type="text" name="title" placeholder="{{__('app.product').' '.__('app.title')}}" class="form-control"  required>
                        </div>
                    </div>
                    <div class="custom-form-group custom-form-group-sm mb-3 row">
                        <label for="name" class="col-lg-4 text-lg-right form-label">{{__('app.price')}} :</label>
                        <div class="col-lg-8">
                            <input type="number" name="price" placeholder="{{__('app.product').' '.__('app.price')}} " class="form-control"  required >
                        </div>
                    </div>
                    <div class="custom-form-group custom-form-group-sm mb-3 row">
                        <label for="name" class="col-lg-4 text-lg-right form-label">{{__('app.description')}} :</label>
                        <div class="col-lg-8">
                            <textarea name="details" placeholder="{{__('app.product').' '.__('app.description').' '.__('app.here')}} !" id="" cols="10" rows="5" class="form-control" required></textarea>
                        </div>
                    </div>
                    <div class="custom-form-group custom-form-group-sm mb-3 row">
                    ...
                    <div class="custom-form-group custom-form-group-sm mb-3 row">
                        <label for="name" class="col-lg-4 text-lg-right form-label">{{__('app.new').' '.__('app.arrival')}} :</label>
                        <div class="col-lg-8">
                            <input type="checkbox" name="new_arrival" value="arrival">
                        </div>
                    </div>
...
<script>
    ...
    $("#category").on("change", function () {
        ...
        $.ajax({
            type: "GET",
            url: base_url+"/admin/product/get-subcategory-by-category/" + category_id,
