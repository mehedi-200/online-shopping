    ...
    <main class="main-content">
        <div class="theme-card">
            <div class="theme-card-header d-flex justify-content-between">
                <h6 class="theme-card-title">{{__('app.edit').' '.__('app.category')}}</h6>
            </div>
            <div class="theme-card-body">
                <form action="{{route('category.update',[$category->id])}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="custom-form-group custom-form-group-sm mb-3 row">
                        ...
                        <div class="col-lg-8">
                            <input type="text" name="name" value='{{$category->name}}' placeholder="{{__('app.category').' '.__('name')}}" class="form-control"  required>
                        </div>
                    </div>
                    <div class="custom-form-group custom-form-group-sm mb-3 row">
                    ...
                    <div class="custom-form-group custom-form-group-sm mb-3 row">
                        ...
                        <div class="col-lg-8">
                            <input type="checkbox" name="display" value="yes" @if($category->display === 'yes') checked @endif>
                        </div>
                    </div>
                    <div class="custom-form-group custom-form-group-sm mb-3 row">
