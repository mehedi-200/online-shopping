    ...
    <main class="main-content">
        ...
        <div class="theme-card">
            <div class="theme-card-header d-flex justify-content-between">
                <h6 class="theme-card-title">{{__('app.create').' '.__('app.sub_category')}}</h6>
            </div>
            <div class="theme-card-body">
                <form action="{{route('sub-category.store')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="custom-form-group custom-form-group-sm mb-3 row">
                        ...
                        <div class="col-lg-8">
                            <input type="text" name="name" placeholder="{{__('app.sub_category').' '.__('name')}}" class="form-control"  required>
                        </div>
                    </div>
                    <div class="custom-form-group custom-form-group-sm mb-3 row">
